...
a persistence unit "ejemplo2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ejemplo2\pom.xml":
...
artifact ("ejemplo2.war") is already built. You can build
